				...
				<div class="sidebar-content">
					...
					<ul class="nav nav-primary">
						<li class="nav-item" id="users">
							<a href="{{ url('master/masteruser') }}">
								<i class="fas fa-user"></i>
								<p>Users</p>
							</a>
						</li>
						<li class="nav-item" id="vendor">
							<a href="{{ url('master/mastervendor') }}">
								<i class="fas fa-tag"></i>
								<p>Vendors</p>
							</a>
						</li>
						<li class="nav-item" id="category">
							<a href="{{ url('master/mastercategory') }}">
								<i class="fas fa-layer-group"></i>
								<p>Categories</p>
							</a>
						</li>
						<li class="nav-item" id="assets">
							<a href="{{ url('master/masterassets') }}">
								<i class="fas fa-chair"></i>
								<p>Assets</p>
							</a>
						</li>
						<li class="nav-item" id="assets">
							<a href="{{ url('master/masterlog') }}">
								<i class="fas fa-chair"></i>
								<p>Journal Assets</p>
							</a>
						</li>
						<li class="nav-item" id="stockopname">
							<a href="{{ url('master/masterstockopname') }}">
